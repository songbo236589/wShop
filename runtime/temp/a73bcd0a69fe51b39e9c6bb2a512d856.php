<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/www/wwwroot/mp.zihai029.com/application/admin/view/index/index.html";i:1533709010;s:68:"/www/wwwroot/mp.zihai029.com/application/admin/view/common/head.html";i:1533002192;s:68:"/www/wwwroot/mp.zihai029.com/application/admin/view/common/foot.html";i:1503623994;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="<?php echo url('admin/index/index'); ?>">
                    <span style="font-size: 22px;"><?php echo $background_title; ?></span>
                </a>
            ...
            <ul class="layui-nav admin-header-item" lay-filter="side-top-right">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd data-skin="2"><a href="javascript:;">蓝色</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
    ...
    <script>
        ...
        layui.use('layer',function(){
            ...
            $('#cache').click(function () {
                layer.confirm('您确定要清除缓存吗！', {icon: 3}, function (data) {
